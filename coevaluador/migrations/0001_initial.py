# Generated by Django 2.1.3 on 2018-11-22 23:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('opened', 'Abierta'), ('closed', 'Cerrada'), ('published', 'Publicada')], default='opened', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('answered', 'Contestada'), ('not_answered', 'Pendiente')], default='not_answered', max_length=100)),
                ('grade', models.CharField(blank=True, max_length=10)),
                ('coevaluated', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coevaluated', to=settings.AUTH_USER_MODEL)),
                ('coevaluation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='coevaluador.Coevaluation')),
                ('coevaluator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coevaluator', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('rango', 'Rango'), ('textbox', 'Cuadro de Texto')], default='rango', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='TeamMember',
